...
public class RemoteLockHandler {
    ...
    public void lockObject(String lockType, String filePath, String serviceName,Timestamp timestamp) throws SQLException{
    ...
    public void releaseObject(String lockType, String filePath) throws SQLException{
    ...
    public boolean isRemoteReadLock(String filePath) throws SQLException {
    ...
    public boolean isRemoteWriteLock(String filePath) throws SQLException {
        String query= "select * from" + dbPersister.getTableName()
                + " where file_path = " + filePath + " and "
                + "lock_type = write";
        return dbPersister.ifSelectReturns(query);
